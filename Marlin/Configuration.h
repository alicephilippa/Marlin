...
#define LIN_ADVANCE                 // with K=0 For TMC_UART prefer mode spreadCycle(by TFT menu) or commented if problem (Default)
#define ARC_SUPPORT                 
//#define POWER_LOSS_RECOVERY       // Continue print after Power-Loss.
...
//#define CUSTOM_MACHINE_NAME "Squashy"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 3000, 8000 }

#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 6000, 6000, 6000, 16000 } // ...or, set your own edit limits
#endif
