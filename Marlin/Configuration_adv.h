 ...
 */
#define XY_FREQUENCY_LIMIT       100 // (Hz) Maximum frequency of small zigzag infill moves. Set with M201 F<hertz>.
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 40*60, 40*60, 40*60, 400 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
//
  ...
  #define LCD_LANGUAGE_2 fr        // French
  #define LCD_LANGUAGE_3 sv        // Swedish
  #define LCD_LANGUAGE_4 es        // Spanish
  #define LCD_LANGUAGE_5 de        // German
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define MM_PER_ARC_SEGMENT      0.1 // (mm) Minimum length of each arc segment
 ...
 */
  ...
  //#define CHOPPER_TIMING_Z4 CHOPPER_TIMING
  ...
  //#define CHOPPER_TIMING_E4 CHOPPER_TIMING
  //#define CHOPPER_TIMING_E5 CHOPPER_TIMING
  //#define CHOPPER_TIMING_E6 CHOPPER_TIMING
  //#define CHOPPER_TIMING_E7 CHOPPER_TIMING
